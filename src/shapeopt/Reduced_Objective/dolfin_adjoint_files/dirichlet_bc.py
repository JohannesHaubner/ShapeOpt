# https://github.com/dolfin-adjoint/dolfin-adjoint/blob/main/src/fenics_adjoint/blocks/dirichlet_bc.py
...
from .utils import function_from_vector, extract_subfunction
