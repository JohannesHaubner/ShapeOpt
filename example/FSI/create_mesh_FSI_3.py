...
if not os.path.exists(str(here) + "/mesh3"):
    os.makedirs(str(here) + "/mesh3")
...
np.save(str(here) + '/mesh3/params.npy', params)
np.save(str(here) + '/mesh3/geom_prop.npy', geom_prop)
...
import gmsh
gmsh.write(str(here) + "/mesh3/mesh.msh")
gmsh.clear()
geometry.__exit__()

import meshio
mesh_from_file = meshio.read(str(here) + "/mesh3/mesh.msh")
...
meshio.write(str(here) + "/mesh3/facet_mesh.xdmf", line_mesh)

triangle_mesh = create_mesh(mesh_from_file, "triangle", prune_z=True)
meshio.write(str(here) + "/mesh3/mesh_triangles.xdmf", triangle_mesh)
