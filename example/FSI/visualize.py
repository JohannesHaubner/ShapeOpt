...
if option == 0:
    ...
    if plot_shapes:
        fnames = ["mesh5/mesh_triangles.xdmf", "mesh5/domains_final.xdmf"] # these files are in folder /example/FSI/
        outname = ["mesh5/init_plot.png", "mesh5/final_plot.png"]
    if generate_table_opt:
        txtname = 'terminal_liftmin_reg01.txt'   # terminal output of simulation needs to be saved to /example/FSI/txtname
        txtout = 'mesh5/table.txt'
        txtout_all = 'mesh5/to_shortened.txt'
    if generate_dp:
        foldernames = ["Init", "Opt"]  # folders in /example/FSI/Output/Forward generated by run_forward
        points = [[0.3, 0.2], [0.301272, 0.190139]]
    if generate_mp4:
        gifnames = ["init_fsi.gif", "opt_fsi.gif"]
    T = 15.0 #time horizon 
    deltat = 0.01 #needed, otherwise numerical issues for large time horizons
