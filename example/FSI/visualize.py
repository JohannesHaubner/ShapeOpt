...
if option == 0:
    ...
    if generate_table_opt:
        txtname = "terminal_interface.txt"   # terminal output of simulation needs to be saved to /example/FSI/txtname
        txtout = 'mesh/table.txt'
        txtout_all = 'mesh/to_shortened.txt'
    if generate_dp:
        foldernames = ["Init_obstacle", "Opt_obstacle"]  # folders in /example/FSI/Output/Forward generated by run_forward
    if generate_mp4:
...
if generate_dp or generate_mp4 or run_forward_opt:
