...
option = 3 # 0: optimization of obstacle, 1: optimzation of interface, 2: extra example 1
if option == 0:
    ...
    if plot_shapes:
        fnames = ["mesh6/mesh_triangles.xdmf", "mesh6/domains_final.xdmf"] # these files are in folder /example/FSI/
        outname = ["mesh6/init_plot.png", "mesh6/final_plot.png"]
    if generate_table_opt:
        txtname = 'terminal_output_liftmin_beta_.txt'   # terminal output of simulation needs to be saved to /example/FSI/txtname
        txtout = 'mesh6/table.txt'
        txtout_all = 'mesh6/to_shortened.txt'
    if generate_dp:
        foldernames = ["Init_op3", "Opt_op3"]  # folders in /example/FSI/Output/Forward generated by run_forward
        points = [[0.275914, 0.201167], [0.26994, 0.186462]]
    if generate_mp4:
        gifnames = ["init_fsi.gif", "opt_fsi.gif"]
    T = 15.0 #time horizon 
    deltat = 0.01 #needed, otherwise numerical issues for large time horizons
